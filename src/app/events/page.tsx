...
import { FaCalendarAlt, FaMapMarkerAlt, FaUsers, FaArrowRight, FaFilter, FaArrowLeft, FaHistory } from 'react-icons/fa';
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-10">
            {loading ? (
              ...
              <div className="col-span-full py-20 bg-white dark:bg-slate-900 rounded-[2rem] border border-slate-200 dark:border-slate-800 text-center shadow-sm">
                ...
                <p className="text-slate-500 font-bold">No upcoming events found.</p>
              </div>
            ) : (
