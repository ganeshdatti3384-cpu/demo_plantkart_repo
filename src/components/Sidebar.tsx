...
import { 
  ...
  FaChevronLeft, FaChevronRight, FaBell, FaCog, FaUsers, FaHistory, FaTrashAlt, FaClipboardList, FaPlus
} from 'react-icons/fa';
...
export default function Sidebar({ activeService = '', userRole: userRoleProp }: SidebarProps) {
  ...
  const adminFeatures = [
    ...
    { name: 'Users Management', link: '/admin/users', icon: <FaUsers className="text-blue-500" /> },
    { name: 'Vendor Management', link: '/admin/vendors', icon: <FaUserTie className="text-amber-600" /> },
    { name: 'Consultant Management', link: '/admin/consultants', icon: <FaUserTie className="text-purple-500" /> },
    { name: 'Accommodation Approvals', link: '/admin/accommodation/pending', icon: <FaHome className="text-emerald-500" /> },
    { name: 'Car Approvals', link: '/admin/car/pending', icon: <FaCar className="text-indigo-500" /> },
    { name: 'Accommodation Bookings', link: '/admin/accommodation/bookings', icon: <FaClipboardList className="text-blue-600" /> },
    { name: 'Car Bookings', link: '/admin/car/bookings', icon: <FaClipboardList className="text-blue-600" /> },
  ...
  const vendorFeatures = [
    { name: 'Vendor Dashboard', link: '/dashboard/vendor', icon: <FaGripHorizontal className="text-blue-500" /> },
    { name: 'Car Listings', link: '/vendor/car', icon: <FaCar className="text-indigo-500" /> },
    { name: 'Car Bookings', link: '/vendor/car/bookings', icon: <FaClipboardList className="text-blue-600" /> },
    { name: 'Add Car', link: '/vendor/car/add', icon: <FaPlus className="text-green-500" /> },
    { name: 'Property Listings', link: '/vendor/accommodation', icon: <FaHome className="text-emerald-500" /> },
    { name: 'Property Bookings', link: '/vendor/accommodation/bookings', icon: <FaClipboardList className="text-blue-600" /> },
    { name: 'Add Property', link: '/vendor/accommodation/add', icon: <FaPlus className="text-green-500" /> },
    { name: 'Profile', link: '/dashboard/vendor/profile', icon: <FaUserCircle className="text-purple-500" /> },
    { name: 'Notifications', link: '/notifications', icon: <FaBell className="text-amber-500" /> },
    { name: 'Support', link: '/support', icon: <FaHandshake className="text-blue-400" /> },
  ];

  const consultantFeatures = [
    { name: 'Consultant Dashboard', link: '/dashboard/consultant', icon: <FaGripHorizontal className="text-blue-500" /> },
    { name: 'Bookings', link: '/consultant-booking/my-bookings', icon: <FaCalendarAlt className="text-blue-600" /> },
    { name: 'Profile', link: '/consultant/profile', icon: <FaUserCircle className="text-purple-500" /> },
  ];
          ...
          <nav className="space-y-0.5">
            ...
            {!collapsed && (
              <div className={`pt-3 pb-1 px-4 text-[9px] font-black uppercase tracking-widest ${isAdmin ? 'text-slate-500' : 'text-slate-400 dark:text-slate-500'}`}>
                {isAdmin ? 'Operation Domains' : 'My Services'}
              </div>
            )}
